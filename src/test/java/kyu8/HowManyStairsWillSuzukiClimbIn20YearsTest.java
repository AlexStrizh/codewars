...
public class HowManyStairsWillSuzukiClimbIn20YearsTest {
    @Test
    public void stairsIn20_BasicTest1() {
        ...
        assertEquals(expectedResult, HowManyStairsWillSuzukiClimbIn20Years.stairsIn20(stairs));
    }
    ...
    public void KiyoLCM_RandomTests() {
        for(int i = 0; i < 40; i++) {
            ...
            System.out.println(HowManyStairsWillSuzukiClimbIn20Years.stairsIn20(stairs));
            assertEquals(expectedResult, HowManyStairsWillSuzukiClimbIn20Years.stairsIn20(stairs));
        }
    }
}