...
public class CountingSheepTest {
    ...
    @Test
    public void test2() {
        assertEquals("There are 500 sheeps in total", 500, new CountingSheep().countSheeps(array2));
    }

    @Test
    public void test3() {
        assertEquals("There are 0 sheeps in total", 0, new CountingSheep().countSheeps(array3));
    }
}